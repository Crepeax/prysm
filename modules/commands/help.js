...
//    																											 .addField(`${prefix}`, ``, true)
			embeds.moderation = new Discord.RichEmbed()
				...
				.addBlankField(true)
				.addField(`${prefix}\`massnick\`, \`mn\`, \`nickall\``, `Change everyone's nickname at once.\nThis is only available for guilds that have less than 50 members.`, true)
				...
				.addField(`${prefix}\`mute\``, `Prevent an user from sending messages and connecting to voice.`, true)
				.addBlankField(true)
			...
			embeds.music = new Discord.RichEmbed()
				...
				.addBlankField(true)
				.addField(`${prefix}\`leave\`, \`reset\`, \`dc\``, `Disconnect the bot from your voice channel.`, true)

...
// To-do: use Enmap instead of json files for storing data
...
let file = JSON.parse(fs.readFileSync("./data-storage/defaultroles.json", "utf8"));
...
let newRoles;
        ...
        switch(args[0]) {
            case 'add':
                ...
                fs.writeFileSync('./data-storage/defaultroles.json', JSON.stringify(file));
                message.react('✅');
